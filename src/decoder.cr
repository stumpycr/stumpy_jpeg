module StumpyJPEG
  ...
  class Decoder
    ...
    def decode(io : IO)
      ...
      #TODO: Try reading a JFIF APP header?
      ...
      # TODO: Raise when additional data is sent?
      # raise "Unexpected data found beyond end of image" if io.read_byte
    ...
    # Parses a DAC marker and assigns it to the specified table id
    # private def parse_dac(io)
    #   puts "DAC found"
    #   dac = DAC.from_io(io)
    #   dac.tables.each do |table|
    #     @dacs[table.table_id] = table
    #   end
    # end
