...
module StumpyJPEG
  module Transformation
    ...
    def self.fast_inverse_transform_component(component : Component, quantization_table : Quantization::Table)
      component.coefficients.reduce({} of Tuple(Int32, Int32) => Matrix(Int32)) do |memo, (coords, coef)|
        memo[coords] = Transformation.fast_inverse_transform(coef, quantization_table)
        memo
      end
    end
